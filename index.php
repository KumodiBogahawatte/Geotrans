...
<body class="bg-gray-50">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div class="flex items-center justify-between mb-6 sm:mb-8">
            ...
            <a href="#" class="text-gray-600 hover:text-purple-custom font-medium">View All</a>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gray-200 rounded-full flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/laptop-screens-with-financial-charts-graphs-white-background 1.png" alt="Laptops"
                        class="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 object-contain">
                </div>
                <span class="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-purple-custom text-center">Laptops</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gray-200 rounded-full flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/blank-desktop-computer 1.png" alt="Desktops"
                        class="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 object-contain">
                </div>
                <span class="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-purple-custom text-center">Desktops</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    ...
                    <img src="assets/images/categories/modern-compact-laser-home-printer-isolated-white-background 1.png" alt="Printers"
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/still-life-cyan-toner-arrangement 1.png" alt="Toners"
                        class="w-16 h-16 object-contain">
                </div>
                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-custom">Toners</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/cat6.png.png" alt="Copiers"
                        class="w-16 h-16 object-contain">
                </div>
                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-custom">Copiers</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                ...
                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-custom">Mouse</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/gaming-keyboard-with-cacklight 1.png" alt="Keyboards"
                        class="w-16 h-16 object-contain">
                </div>
                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-custom">Keyboards</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/cat9.png.png" alt="Monitors"
                        class="w-16 h-16 object-contain">
                </div>
                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-custom">Monitors</span>
            </div>
            ...
            <div class="flex flex-col items-center group cursor-pointer">
                <div
                    class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mb-3 group-hover:bg-purple-100 transition-colors">
                    <img src="assets/images/categories/cat10.png.png" alt="Audios"
                        class="w-16 h-16 object-contain">
                </div>
                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-custom">Audios</span>
            </div>
