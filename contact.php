        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-start">
                ...
                <form id="contact-form" class="space-y-4 sm:space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                name="first_name"
                                required
                                class="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#680e68] focus:border-transparent text-base sm:text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#680e68] focus:border-transparent resize-none text-base sm:text-sm"></textarea>
                    </div>
                    ...
                    <div class="flex items-start">
                        <input
                            ...
                            id="terms"
                            required
                            class="mt-1 w-5 h-5 sm:w-4 sm:h-4 text-[#680e68] border-gray-300 rounded focus:ring-[#680e68] flex-shrink-0">
                        <label for="terms" class="ml-3 sm:ml-2 text-sm text-gray-600 leading-relaxed">
                            ...
                            <a href="#" class="text-[#680e68] hover:text-[#680e68] underline">Terms & Conditions</a>
                        </label>
                    </div>
                    ...
                    <button
                        type="submit"
                        id="submit-btn"
                        class="w-full sm:w-auto bg-[#680e68] hover:bg-[#4f0a4f] text-white font-semibold px-8 py-3 sm:py-2 rounded-lg transition-colors text-base sm:text-sm">
                        SEND MESSAGE
                    </button>
            ...
            <div class="flex flex-col order-1 lg:order-2">
                ...
                <div class="bg-white rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-sm">
                    ...
                    <p class="text-[#680e68] font-semibold mb-2 text-sm sm:text-base">071 3757555</p>
                    <p class="text-gray-700 mb-3 text-sm">Email: <a href="mailto:info@geotrans.com" class="text-[#680e68] font-semibold break-all">info@geotrans.com</a></p>

                    <div class="h-px bg-gray-200 my-4"></div>

                    <p class="text-xs text-gray-500 uppercase mb-2">BRANCH 2 SHOWROOM</p>
                    <h3 class="font-bold text-gray-900 mb-2 text-sm sm:text-base">No 60 Dhamma Road Colombo 06</h3>
                    <p class="text-[#680e68] font-semibold text-sm sm:text-base">071 3757555</p>

                    <!-- Social Media Links (moved inside info card) -->
                    <div class="flex space-x-3 mt-4">
                        <a href="#" class="w-10 h-10 sm:w-9 sm:h-9 bg-gray-900 hover:bg-[#680e68] text-white rounded-lg flex items-center justify-center transition-colors">
